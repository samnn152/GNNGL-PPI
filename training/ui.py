...
class TerminalTrainingUI(TrainingObserver):
    ...
    def __init__(self, context):
        ...
        self.message = "Initializing training pipeline"
    ...
    def _render(self, force=False):
        ...
        lines = [
            ...
            "+" + "-" * (width - 2) + "+",
            "| " + self._color("Files and current training data".ljust(content_width), self.CYAN) + " |",
        ]
