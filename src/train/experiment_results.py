...
def append_train_result(path, args, final_stats):
    ...
    append_result(path, {
        ...
        'train_time_seconds': final_stats.get('train_time_seconds', ''),
        'model_size_mb': final_stats.get('model_size_mb', ''),
...
def append_test_result(path, args, evaluation_split, metrics):
